  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--brand-neon) / 0.35), 0 0 60px hsl(var(--brand-neon) / 0.15)" },
          "50%": { boxShadow: "0 0 35px hsl(var(--brand-neon) / 0.55), 0 0 80px hsl(var(--brand-neon) / 0.3)" },
        },
        "bounce-gentle": {
